...
<p align="center"><img alt="OSPTEK 3.82 寸 280×1020 TFT MIPI 模组（AXS15231B）宣传图" src="./images/product.png" width="640" /></p>
...
```text
tft-3.82-280x1020-mipi-axs15231b/                                # 仓库根（导航见 ../../README.md）
└── versions/
