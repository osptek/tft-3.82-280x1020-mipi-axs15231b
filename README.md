...
本仓库收录 **3.82 寸 280×1020 TFT（MIPI · AXS15231B）** 显示模组资料。

**根目录 README 为导航页**。下表可快速浏览各版本；点击「完整资料」进入 `versions/` 下对应**料号文件夹**（产品页、规格书、示例均在该目录内）。

规格标识（仓库名）：`tft-3.82-280x1020-mipi-axs15231b`
...
| 版本 | 宣传图 | 简介 | 完整资料 |
| ---- | ------ | ---- | -------- |
| YDP382B001-V13 | <img alt="YDP382B001-V13" src="./versions/YDP382B001-V13/images/product.png" width="120" /> | [简介](#ydp382b001-v13) | [完整资料](./versions/YDP382B001-V13/) |

---

## YDP382B001-V13

<p align="center"><img alt="YDP382B001-V13" src="./versions/YDP382B001-V13/images/product.png" width="320" /></p>

**说明：** 带触摸（AXS15231B）。

完整产品页、规格书与示例：[versions/YDP382B001-V13/](./versions/YDP382B001-V13/)
